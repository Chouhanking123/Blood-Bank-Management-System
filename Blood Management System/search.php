...
<div class="container" style="padding: 60px 0 60px 0;">
	...
	<?php
if 
( ( isset($_GET['city' ]) && !empty($_GET[ 'city' ]) ) && ( isset($_GET['blood_group' ]) && !
