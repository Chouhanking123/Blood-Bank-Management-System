<?php 
  ...
  if(isset($_POST['submit'])){
      if(isset($_POST['term'])=== true){
	   ...
	   }else {$nameError = '<div class="alert alert-success alert-dismissible fade show" role="alert">
...
<span aria-hidden="true">&times;</span>
  ...
  $contact = $contactError = ''; // Initialize variables
  if (isset($_POST['contact_no']) && !empty($_POST['contact_no'])) {
	  // Use a valid pattern for phone number (10-15 digits, optional leading +)
	  if (preg_match("/^\+?[0-9]{10,15}$/", $_POST['contact_no'])) {
		  $contact = $_POST['contact_no']; // Assign valid input to $contact
	  } else {
		  // Error message if the input doesn't match the pattern
		  $contactError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
			  <strong>Contact number should be 10 to 15 digits and may include a "+" at the beginning.</strong>
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
			  </button>
		  </div>';
	  ...
	  // Error message if the contact number field is empty
	  $contactError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
		  <strong>Please fill in the contact number field.</strong>
		  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
		  </button>
	  </div>';
  ...
  if (isset($_POST['password']) && !empty($_POST['password']) && isset($_POST['c_password']) && !empty($_POST['c_password'])) {
	  if (strlen($_POST['password']) >= 6) {
		  ...
		  $passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
			  <strong>Password should consist of at least 6 characters.</strong>
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			  </button>
			  </div>';
	  ...
	  $passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
		  <strong>Please fill in both password fields.</strong>
		  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
		  <span aria-hidden="true">&times;</span>
		  </button>
		  </div>';
	...
	//email check
		...
		}else {$emailError = '<div class="alert alert-success alert-dismissible fade show" role="alert">
...
// Insert data into database (no changes to your original SQL insertion here)
...
$sql = "INSERT INTO donor (name, gender, email, city, dob, contact_no, save_life_date, password, blood_group)
        VALUES (
            ...
            '" . mysqli_real_escape_string($connection, $check_email) . "',
            '" . mysqli_real_escape_string($connection, $city) . "',
            '$DonorDOB',
            '" . mysqli_real_escape_string($connection, $contact) . "',
            '0',
            '" . mysqli_real_escape_string($connection, $password) . "',
            '" . mysqli_real_escape_string($connection, $blood_group) . "'
        )";
...
if (mysqli_query($connection, $sql)) {
   header("location: signin.php");
    ...
    $submitError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
		...
		<strong>Please agare with our terms and conditions</strong>
		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
		</button>
		</div>';
...
<div class="container size">
		...
		<div class="col-md-6 offset-md-3 form-container">
          ...
          <!-- Error Messages -->
              ...
              <select class="form-control demo-default" id="year" name="year" style="margin-bottom:10px;" required>
                ...
                <option value="1957" >1957</option><option value="1958" >1958</option><option value="1959" >1959</option><option value="1960" >1960</option><option value="1961" >1961</option><option value="1962" >1962</option><option value="1963" >1963</option><option value="1964" >1964</option><option value="1965" >1965</option><option value="1966" >1966</option><option value="1967" >1967</option><option value="1968" >1968</option><option value="1969" >1969</option><option value="1970" >1970</option><option value="1971" >1971</option><option value="1972" >1972</option><option value="1973" >1973</option><option value="1974" >1974</option><option value="1975" >1975</option><option value="1976" >1976</option><option value="1977" >1977</option><option value="1978" >1978</option><option value="1979" >1979</option><option value="1980" >1980</option><option value="1981" >1981</option><option value="1982" >1982</option><option value="1983" >1983</option><option value="1984" >1984</option><option value="1985" >1985</option><option value="1986" >1986</option><option value="1987" >1987</option><option value="1988" >1988</option><option value="1989" >1989</option><option value="1990" >1990</option><option value="1991" >1991</option><option value="1992" >1992</option><option value="1993" >1993</option><option value="1994" >1994</option><option value="1995" >1995</option><option value="1996" >1996</option><option value="1997" >1997</option><option value="1998" >1998</option><option value="1999" >1999</option><option value="1999" >2000</option><option value="1999" >2001</option><option value="1999" >2002</option><option value="1999" >2003</option><option value="1999" >2004</option><option value="1999" >2005</option>
              </select>
    ...
    <input type="text" name="contact_no" id="contact_no" value="" 
        placeholder="03********" class="form-control" required 
        pattern="^\+?[0-9]{10,15}$" title="Contact number should be 10 to 15 digits, optionally starting with a +." maxlength="15">
    <!-- Display contact error message if it exists -->
    ...
    <div class="form-group">
        ...
        <input type="password" name="password" placeholder="Password" class="form-control" required pattern=".{6,}">
    </div><!--End form-group-->
 
    <div class="form-group">
        <label for="c_password">Confirm Password</label>
        <input type="password" name="c_password" placeholder="Confirm Password" class="form-control" required pattern=".{6,}">
